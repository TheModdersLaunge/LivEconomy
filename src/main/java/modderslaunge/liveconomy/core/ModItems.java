...
public class ModItems {
    ...
    public static final RegistryObject<CardItem> CARD = ITEMS.register("debit_card",
            () -> new CardItem(new Item.Properties().stacksTo(1).setNoRepair().rarity(Rarity.EPIC)));

    public static final RegistryObject<WalletItem> WALLET = ITEMS.register("wallet",
            () -> new WalletItem(new Item.Properties().stacksTo(1).setNoRepair().rarity(Rarity.EPIC)));
